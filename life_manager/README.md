...
2. Dateien ersetzen.
3. Add-on neu bauen.
4. `/health` muss Version `1.7.0` liefern.
...
- Der Quest Manager zeigt unten `Frontend v1.7.0`, damit Cache-Probleme sofort erkennbar sind.


## v1.7.0 Achievements, Boss Fights & Streaks
...
The planner is intentionally rule-based in v1.7.0 so every recommendation remains
explainable. An optional AI layer can be added later without replacing the
deterministic core.


## v1.7.0 Planner Today Fix
...
## v1.7.0 Stable Home Assistant data transport
...
From v1.7.0 onward `/dashboard` also exposes the complete response under:
...
`examples/life_manager_sensor_v1.7.0.yaml`
...
v1.7.0 uses a permanent loader instead.
...
`/local/life-manager-1.7.0.js?v=1.7.0`
...
## v1.7.0 Scheduling UI + Analytics
...
## v1.7.0 Generated Home Assistant Bridge
...
first update to v1.7.0, perform one Home Assistant Core restart if the generated
...
## v1.7.0 Home Assistant package path detection
...
## v1.7.0 Home Assistant bridge fix
...
## v1.7.0 Home Assistant bridge restored
...
## v1.7.0 Home Assistant bridge fields hotfix
...
## v1.7.0 Occurrence diagnostic split
...
## v1.7.0 Occurrence entity rename
...
## v1.7.0 Complete Dashboard Card
...
## v1.7.0 Dashboard Management hotfix
...
## v1.7.0 Quest Editor focus hotfix
