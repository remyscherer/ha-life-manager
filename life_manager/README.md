...
2. Dateien ersetzen.
3. Add-on neu bauen.
4. `/health` muss Version `1.6.1` liefern.
...
- Der Quest Manager zeigt unten `Frontend v1.6.1`, damit Cache-Probleme sofort erkennbar sind.


## v1.6.1 Achievements, Boss Fights & Streaks
...
The planner is intentionally rule-based in v1.6.1 so every recommendation remains
explainable. An optional AI layer can be added later without replacing the
deterministic core.


## v1.6.1 Planner Today Fix
...
## v1.6.1 Stable Home Assistant data transport
...
From v1.6.1 onward `/dashboard` also exposes the complete response under:
...
`examples/life_manager_sensor_v1.6.1.yaml`
...
v1.6.1 uses a permanent loader instead.
...
`/local/life-manager-1.6.1.js?v=1.6.1`
...
## v1.6.1 Scheduling UI + Analytics
...
## v1.6.1 Generated Home Assistant Bridge
...
first update to v1.6.1, perform one Home Assistant Core restart if the generated
...
## v1.6.1 Home Assistant package path detection
...
## v1.6.1 Home Assistant bridge fix
...
## v1.6.1 Home Assistant bridge restored
...
## v1.6.1 Home Assistant bridge fields hotfix
...
## v1.6.1 Occurrence diagnostic split
...
## v1.6.1 Occurrence entity rename
...
## v1.6.1 Complete Dashboard Card
