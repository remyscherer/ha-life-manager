...
- Quest, Training, Habit, Routine, Boss, XP, Willpower, Coin, Consistency and Streak achievements
- automatic progress calculation
- one-time Coin rewards for every unlock
- unlock titles such as `Quest Machine`, `Boss Hunter`, `Unbreakable` and `Final Boss`
- current title shown in the dashboard
- progress bars and full achievement grid
- recent unlock banner
- retroactive evaluation of existing Life Manager history
