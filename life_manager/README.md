...
2. Dateien ersetzen.
3. Add-on neu bauen.
4. `/health` muss Version `1.7.4` liefern.
...
- Der Quest Manager zeigt unten `Frontend v1.7.4`, damit Cache-Probleme sofort erkennbar sind.


## v1.7.4 Achievements, Boss Fights & Streaks
...
The planner is intentionally rule-based in v1.7.4 so every recommendation remains
explainable. An optional AI layer can be added later without replacing the
deterministic core.


## v1.7.4 Planner Today Fix
...
## v1.7.4 Stable Home Assistant data transport
...
From v1.7.4 onward `/dashboard` also exposes the complete response under:
...
`examples/life_manager_sensor_v1.7.4.yaml`
...
v1.7.4 uses a permanent loader instead.
...
`/local/life-manager-1.7.4.js?v=1.7.4`
...
## v1.7.4 Scheduling UI + Analytics
...
## v1.7.4 Generated Home Assistant Bridge
...
first update to v1.7.4, perform one Home Assistant Core restart if the generated
...
## v1.7.4 Home Assistant package path detection
...
## v1.7.4 Home Assistant bridge fix
...
## v1.7.4 Home Assistant bridge restored
...
## v1.7.4 Home Assistant bridge fields hotfix
...
## v1.7.4 Occurrence diagnostic split
...
## v1.7.4 Occurrence entity rename
...
## v1.7.4 Complete Dashboard Card
...
## v1.7.4 Dashboard Management hotfix
...
## v1.7.4 Quest Editor focus hotfix
...
## v1.7.4 SQLite date/time compatibility
...
## v1.7.4 Quest bridge compatibility hotfix
...
## v1.7.4 Home Assistant payload normalization
