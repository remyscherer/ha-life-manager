...
def main():
    ...
    with engine.begin() as c:
        pending_import = (
            os.environ.get("MIGRATE_FROM_MARIADB", "false").lower() == "true"
            and not Path("/data/.mariadb_import_done").exists()
        )
        ...
        c.execute(text("""
            ...
            VALUES('schema_version','1.7.1',CURRENT_TIMESTAMP)
        ...
        c.execute(text("""
            ...
            VALUES('171_mariadb_decimal_import_fix')
